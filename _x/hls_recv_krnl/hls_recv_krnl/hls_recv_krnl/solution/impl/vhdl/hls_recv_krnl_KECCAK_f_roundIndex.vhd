...
entity hls_recv_krnl_KECCAK_f_roundIndex_rom is 
    generic(
             DWIDTH     : integer := 64; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 24
...
architecture rtl of hls_recv_krnl_KECCAK_f_roundIndex_rom is 
...
entity hls_recv_krnl_KECCAK_f_roundIndex is
    generic (
...
architecture arch of hls_recv_krnl_KECCAK_f_roundIndex is
    component hls_recv_krnl_KECCAK_f_roundIndex_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    hls_recv_krnl_KECCAK_f_roundIndex_rom_U :  component hls_recv_krnl_KECCAK_f_roundIndex_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
