...
entity hls_recv_krnl_updateKey_decipher_0_2_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of hls_recv_krnl_updateKey_decipher_0_2_rom is 
...
entity hls_recv_krnl_updateKey_decipher_0_2 is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of hls_recv_krnl_updateKey_decipher_0_2 is
    component hls_recv_krnl_updateKey_decipher_0_2_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    hls_recv_krnl_updateKey_decipher_0_2_rom_U :  component hls_recv_krnl_updateKey_decipher_0_2_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
