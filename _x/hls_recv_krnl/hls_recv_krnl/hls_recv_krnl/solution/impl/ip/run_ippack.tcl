...
set Library     "hls"
set IPName      "hls_recv_krnl"
set Version     "1.0"
set DisplayName "Hls_recv_krnl"
set Revision    "2112808639"
...
set xo_kernel_name "hls_recv_krnl"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/space1/hxh/APB/sha_aes_tcpip/Vitis_with_100Gbps_TCP-IP/_x/hls_recv_krnl/hls_recv_krnl/hls_recv_krnl/solution"
set debug_dir "/space1/hxh/APB/sha_aes_tcpip/Vitis_with_100Gbps_TCP-IP/_x/hls_recv_krnl/hls_recv_krnl/hls_recv_krnl/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {hls_recv_krnl_fifo_w16_d2_S
hls_recv_krnl_fifo_w32_d3_S
hls_recv_krnl_fifo_w32_d2_S
hls_recv_krnl_fifo_w16_d2_S
hls_recv_krnl_fifo_w16_d512_A
hls_recv_krnl_fifo_w64_d2_S
...
hls_recv_krnl_regslice_both
hls_recv_krnl_regslice_both
hls_recv_krnl_fifo_w32_d2_S_x
hls_recv_krnl_fifo_w32_d2_S_x
hls_recv_krnl_fifo_w64_d2_S_x
hls_recv_krnl_fifo_w64_d2_S_x
hls_recv_krnl_fifo_w32_d2_S_x
hls_recv_krnl_fifo_w32_d2_S_x
hls_recv_krnl_fifo_w64_d2_S_x
...
hls_recv_krnl_fifo_w512_d2_S
hls_recv_krnl_fifo_w32_d2_S_x
hls_recv_krnl_fifo_w1_d1_S
hls_recv_krnl_fifo_w128_d2_S
hls_recv_krnl_fifo_w64_d2_S_x
hls_recv_krnl_fifo_w512_d2_S
hls_recv_krnl_fifo_w32_d2_S_x
hls_recv_krnl_fifo_w32_d2_S_x
hls_recv_krnl_fifo_w512_d2_S
hls_recv_krnl_fifo_w256_d2_S
hls_recv_krnl_fifo_w1_d1_S
hls_recv_krnl_fifo_w128_d2_S
hls_recv_krnl_fifo_w1_d1_S
hls_recv_krnl_fifo_w256_d2_S
...
hls_recv_krnl_fifo_w1_d1_S
hls_recv_krnl_fifo_w32_d2_S_x
hls_recv_krnl_start_for_hls_recv_krnl_entry45_U0
hls_recv_krnl_start_for_Block_split11_proc_U0
hls_recv_krnl_start_for_listenPorts_U0
hls_recv_krnl_start_for_recvData_U0
hls_recv_krnl_start_for_backgroundclock_U0
hls_recv_krnl_start_for_partition_U0
hls_recv_krnl_start_for_consumetrans_U0
hls_recv_krnl_start_for_prepare_sha_U0
hls_recv_krnl_start_for_mysha_U0
hls_recv_krnl_start_for_consumesha_U0
hls_recv_krnl_start_for_prepare_aes_U0
hls_recv_krnl_start_for_myaes_U0
hls_recv_krnl_start_for_consumeaes_U0
...
## Variables
set Top "hls_recv_krnl"
set TopNoPrefix "hls_recv_krnl"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 useConn W 0x0 "Data signal of useConn" {{0 32 useConn W 0 "Bit 31 to 0 of useConn"}}} {0x18 basePort W 0x0 "Data signal of basePort" {{0 32 basePort W 0 "Bit 31 to 0 of basePort"}}} {0x20 delay W 0x0 "Data signal of delay" {{0 32 delay W 0 "Bit 31 to 0 of delay"}}} {0x28 expectedRxByteCnt_1 W 0x0 "Data signal of expectedRxByteCnt" {{0 32 expectedRxByteCnt W 0 "Bit 31 to 0 of expectedRxByteCnt"}}} {0x2c expectedRxByteCnt_2 W 0x0 "Data signal of expectedRxByteCnt" {{0 32 expectedRxByteCnt W 0 "Bit 63 to 32 of expectedRxByteCnt"}}} {0x34 out_time_1 W 0x0 "Data signal of out_time" {{0 32 out_time W 0 "Bit 31 to 0 of out_time"}}} {0x38 out_time_2 W 0x0 "Data signal of out_time" {{0 32 out_time W 0 "Bit 63 to 32 of out_time"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem s_axis_udp_rx m_axis_udp_tx s_axis_udp_rx_meta m_axis_udp_tx_meta m_axis_tcp_listen_port s_axis_tcp_port_status m_axis_tcp_open_connection s_axis_tcp_open_status m_axis_tcp_close_connection s_axis_tcp_notification m_axis_tcp_read_pkg s_axis_tcp_rx_meta s_axis_tcp_rx_data m_axis_tcp_tx_meta m_axis_tcp_tx_data s_axis_tcp_tx_status"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    s_axis_udp_rx_meta {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_udp_rx_meta"
        has_tready "1"
        ports {
            TDATA 256
            TKEEP 32
    ...
    m_axis_udp_tx_meta {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_udp_tx_meta"
        has_tready "1"
        ports {
            TDATA 256
            TKEEP 32
    ...
    m_axis_tcp_listen_port {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tcp_listen_port"
        has_tready "1"
        ports {
            TDATA 16
            TKEEP 2
    ...
    s_axis_tcp_port_status {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tcp_port_status"
        has_tready "1"
        ports {
            TDATA 8
            TKEEP 1
    ...
    m_axis_tcp_open_connection {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tcp_open_connection"
        has_tready "1"
        ports {
            TDATA 64
            TKEEP 8
    ...
    s_axis_tcp_open_status {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tcp_open_status"
        has_tready "1"
        ports {
            TDATA 128
            TKEEP 16
    ...
    m_axis_tcp_close_connection {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tcp_close_connection"
        has_tready "1"
        ports {
            TDATA 16
            TKEEP 2
    ...
    s_axis_tcp_notification {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tcp_notification"
        has_tready "1"
        ports {
            TDATA 128
            TKEEP 16
    ...
    m_axis_tcp_read_pkg {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tcp_read_pkg"
        has_tready "1"
        ports {
            TDATA 32
            TKEEP 4
    ...
    s_axis_tcp_rx_meta {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tcp_rx_meta"
        has_tready "1"
        ports {
            TDATA 16
            TKEEP 2
    ...
    s_axis_tcp_rx_data {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tcp_rx_data"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
    ...
    m_axis_tcp_tx_meta {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tcp_tx_meta"
        has_tready "1"
        ports {
            TDATA 32
            TKEEP 4
    ...
    m_axis_tcp_tx_data {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tcp_tx_data"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
    ...
    s_axis_tcp_tx_status {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tcp_tx_status"
        has_tready "1"
        ports {
            TDATA 64
            TKEEP 8
...
source -notrace "/space1/Xilinx20202/Vitis_HLS/2020.2/common/scripts/ipxhls.tcl"
