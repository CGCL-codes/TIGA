set moduleName tie_off_tcp_close_con
set isTopModule 0
...
set C_modelName {tie_off_tcp_close_con}
...
set C_modelArgMapList {[ 
	{ "Name" : "m_axis_tcp_close_connection_V_data_V", "interface" : "axis", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "m_axis_tcp_close_connection_V_keep_V", "interface" : "axis", "bitwidth" : 2, "direction" : "WRITEONLY"} , 
 	{ "Name" : "m_axis_tcp_close_connection_V_strb_V", "interface" : "axis", "bitwidth" : 2, "direction" : "WRITEONLY"} , 
 	{ "Name" : "m_axis_tcp_close_connection_V_last_V", "interface" : "axis", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axis_tcp_close_connection_TDATA sc_out sc_lv 16 signal 0 } 
	{ m_axis_tcp_close_connection_TVALID sc_out sc_logic 1 outvld 3 } 
	{ m_axis_tcp_close_connection_TREADY sc_in sc_logic 1 outacc 3 } 
	{ m_axis_tcp_close_connection_TKEEP sc_out sc_lv 2 signal 1 } 
	{ m_axis_tcp_close_connection_TSTRB sc_out sc_lv 2 signal 2 } 
	{ m_axis_tcp_close_connection_TLAST sc_out sc_lv 1 signal 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tcp_close_connection_V_data_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tcp_close_connection_V_keep_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tcp_close_connection_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tcp_close_connection_V_last_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	m_axis_tcp_close_connection_V_last_V { axis {  { m_axis_tcp_close_connection_TVALID out_vld 1 1 }  { m_axis_tcp_close_connection_TREADY out_acc 0 1 }  { m_axis_tcp_close_connection_TLAST out_data 1 1 } } }
}
