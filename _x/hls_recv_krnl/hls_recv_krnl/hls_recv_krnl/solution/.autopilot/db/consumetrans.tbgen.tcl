...
set C_modelName {consumetrans}
set C_modelType { void 0 }
set C_modelArgList {
	{ ComputeWordCnt_loc int 32 regular {fifo 0}  }
	{ s_data_out int 512 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ComputeWordCnt_loc", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "s_data_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s_data_out_dout sc_in sc_lv 512 signal 1 } 
	{ s_data_out_empty_n sc_in sc_logic 1 signal 1 } 
	{ s_data_out_read sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_data_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "s_data_out", "role": "dout" }} , 
 	{ "name": "s_data_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_data_out", "role": "empty_n" }} , 
 	{ "name": "s_data_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_data_out", "role": "read" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "s_data_out", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	s_data_out { ap_fifo {  { s_data_out_dout fifo_data 0 512 }  { s_data_out_empty_n fifo_status 0 1 }  { s_data_out_read fifo_update 1 1 } } }
}
