...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { basePort_dout { I 32 vector } basePort_empty_n { I 1 bit } basePort_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { expectedRxByteCnt_dout { I 64 vector } expectedRxByteCnt_empty_n { I 1 bit } expectedRxByteCnt_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 16 \
    name expectedRxByteCnt_out1 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_expectedRxByteCnt_out1 \
    op interface \
    ports { expectedRxByteCnt_out1_din { O 64 vector } expectedRxByteCnt_out1_full_n { I 1 bit } expectedRxByteCnt_out1_write { O 1 bit } } \
} "
}
