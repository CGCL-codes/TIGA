set moduleName listen_port_handler
set isTopModule 0
...
set C_modelName {listen_port_handler}
set C_modelType { void 0 }
set C_modelArgList {
	{ basePort int 16 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "basePort", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ basePort sc_in sc_lv 16 signal 0 } 
	...
	{ m_axis_tcp_listen_port_TREADY sc_in sc_logic 1 outacc 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "basePort", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "basePort", "role": "default" }} , 
 	...
 	{ "name": "m_axis_tcp_listen_port_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "m_axis_tcp_listen_port_V_data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "basePort", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "1"},
...
set Spec2ImplPortList { 
	basePort { ap_none {  { basePort in_data 0 16 } } }
	useConn { ap_fifo {  { useConn_dout fifo_data 0 32 }  { useConn_empty_n fifo_status 0 1 }  { useConn_read fifo_update 1 1 } } }
	m_axis_tcp_listen_port_V_data_V { axis {  { m_axis_tcp_listen_port_TDATA out_data 1 16 }  { m_axis_tcp_listen_port_TREADY out_acc 0 1 } } }
	...
	m_axis_tcp_listen_port_V_last_V { axis {  { m_axis_tcp_listen_port_TVALID out_vld 1 1 }  { m_axis_tcp_listen_port_TLAST out_data 1 1 } } }
}
