set moduleName recvData_consumeData
set isTopModule 0
...
set C_modelName {recvData_consumeData}
set C_modelType { void 0 }
set C_modelArgList {
	{ nextRxPacketLength3 int 16 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "nextRxPacketLength3", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ nextRxPacketLength3_dout sc_in sc_lv 16 signal 0 } 
	{ nextRxPacketLength3_empty_n sc_in sc_logic 1 signal 0 } 
	{ nextRxPacketLength3_read sc_out sc_logic 1 signal 0 } 
	...
	{ s_axis_tcp_rx_meta_TDATA sc_in sc_lv 16 signal 2 } 
	{ s_axis_tcp_rx_meta_TVALID sc_in sc_logic 1 invld 2 } 
	{ s_axis_tcp_rx_meta_TREADY sc_out sc_logic 1 inacc 5 } 
	{ s_axis_tcp_rx_meta_TKEEP sc_in sc_lv 2 signal 3 } 
	{ s_axis_tcp_rx_meta_TSTRB sc_in sc_lv 2 signal 4 } 
	{ s_axis_tcp_rx_meta_TLAST sc_in sc_lv 1 signal 5 } 
	{ s_axis_tcp_rx_data_TDATA sc_in sc_lv 512 signal 6 } 
	{ s_axis_tcp_rx_data_TVALID sc_in sc_logic 1 invld 6 } 
	{ s_axis_tcp_rx_data_TREADY sc_out sc_logic 1 inacc 9 } 
	{ s_axis_tcp_rx_data_TKEEP sc_in sc_lv 64 signal 7 } 
	{ s_axis_tcp_rx_data_TSTRB sc_in sc_lv 64 signal 8 } 
	{ s_axis_tcp_rx_data_TLAST sc_in sc_lv 1 signal 9 } 
	{ s_data_net_out_din sc_out sc_lv 512 signal 10 } 
	{ s_data_net_out_full_n sc_in sc_logic 1 signal 10 } 
	{ s_data_net_out_write sc_out sc_logic 1 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "nextRxPacketLength3_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "nextRxPacketLength3", "role": "dout" }} , 
 	{ "name": "nextRxPacketLength3_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nextRxPacketLength3", "role": "empty_n" }} , 
 	{ "name": "nextRxPacketLength3_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "nextRxPacketLength3", "role": "read" }} , 
 	...
 	{ "name": "s_axis_tcp_rx_meta_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "s_axis_tcp_rx_meta_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "s_axis_tcp_rx_data_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "s_axis_tcp_rx_data_V_data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "nextRxPacketLength3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "512", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	nextRxPacketLength3 { ap_fifo {  { nextRxPacketLength3_dout fifo_data 0 16 }  { nextRxPacketLength3_empty_n fifo_status 0 1 }  { nextRxPacketLength3_read fifo_update 1 1 } } }
	...
	s_axis_tcp_rx_meta_V_data_V { axis {  { s_axis_tcp_rx_meta_TDATA in_data 0 16 }  { s_axis_tcp_rx_meta_TVALID in_vld 0 1 } } }
	...
	s_axis_tcp_rx_meta_V_last_V { axis {  { s_axis_tcp_rx_meta_TREADY in_acc 1 1 }  { s_axis_tcp_rx_meta_TLAST in_data 0 1 } } }
	s_axis_tcp_rx_data_V_data_V { axis {  { s_axis_tcp_rx_data_TDATA in_data 0 512 }  { s_axis_tcp_rx_data_TVALID in_vld 0 1 } } }
	...
	s_axis_tcp_rx_data_V_last_V { axis {  { s_axis_tcp_rx_data_TREADY in_acc 1 1 }  { s_axis_tcp_rx_data_TLAST in_data 0 1 } } }
