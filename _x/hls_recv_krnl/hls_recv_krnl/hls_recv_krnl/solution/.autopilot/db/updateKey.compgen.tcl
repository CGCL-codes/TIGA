...
set id 172
set name hls_recv_krnl_mux_164_1_1_1
...
set id 180
set name hls_recv_krnl_mux_164_128_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
set ID 197
set hasByteEnable 0
set MemName hls_recv_krnl_updateKey_decipher_0_2
...
set ID 198
set hasByteEnable 0
set MemName hls_recv_krnl_updateKey_Rcon
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 10
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_cipherkey \
    op interface \
    ports { cipherkey { I 256 vector } } \
} "
}
