set moduleName listenPorts_Block_split2_proc
set isTopModule 0
...
set C_modelName {listenPorts_Block_.split2_proc}
set C_modelType { int 16 }
set C_modelArgList {
	{ basePort int 16 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "basePort", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ basePort_dout sc_in sc_lv 16 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "basePort_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "basePort", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	basePort { ap_fifo {  { basePort_dout fifo_data 0 16 }  { basePort_empty_n fifo_status 0 1 }  { basePort_read fifo_update 1 1 } } }
}
