...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { plaintextStrm_dout { I 128 vector } plaintextStrm_empty_n { I 1 bit } plaintextStrm_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { endPlaintextStrm_dout { I 1 vector } endPlaintextStrm_empty_n { I 1 bit } endPlaintextStrm_read { O 1 bit } } \
} "
}
