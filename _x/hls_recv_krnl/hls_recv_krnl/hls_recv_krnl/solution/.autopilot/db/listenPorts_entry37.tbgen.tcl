set moduleName listenPorts_entry37
set isTopModule 0
...
set C_modelName {listenPorts.entry37}
set C_modelType { void 0 }
set C_modelArgList {
	{ basePort int 32 regular {fifo 0}  }
	{ useConn int 32 regular {fifo 0}  }
	{ basePort_out int 16 regular {fifo 1}  }
	{ useConn_out int 32 regular {fifo 1}  }
	{ useConn_out1 int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "basePort", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "basePort_out", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "useConn_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "useConn_out1", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ basePort_out_din sc_out sc_lv 16 signal 2 } 
	{ basePort_out_full_n sc_in sc_logic 1 signal 2 } 
	{ basePort_out_write sc_out sc_logic 1 signal 2 } 
	{ useConn_out_din sc_out sc_lv 32 signal 3 } 
	{ useConn_out_full_n sc_in sc_logic 1 signal 3 } 
	{ useConn_out_write sc_out sc_logic 1 signal 3 } 
	{ useConn_out1_din sc_out sc_lv 32 signal 4 } 
	{ useConn_out1_full_n sc_in sc_logic 1 signal 4 } 
	{ useConn_out1_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "basePort_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "basePort_out", "role": "din" }} , 
 	...
 	{ "name": "useConn_out1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "useConn_out1", "role": "din" }} , 
 	{ "name": "useConn_out1_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "useConn_out1", "role": "full_n" }} , 
 	{ "name": "useConn_out1_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "useConn_out1", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "useConn_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "useConn_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "useConn_out1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	basePort_out { ap_fifo {  { basePort_out_din fifo_data 1 16 }  { basePort_out_full_n fifo_status 0 1 }  { basePort_out_write fifo_update 1 1 } } }
	useConn_out { ap_fifo {  { useConn_out_din fifo_data 1 32 }  { useConn_out_full_n fifo_status 0 1 }  { useConn_out_write fifo_update 1 1 } } }
	useConn_out1 { ap_fifo {  { useConn_out1_din fifo_data 1 32 }  { useConn_out1_full_n fifo_status 0 1 }  { useConn_out1_write fifo_update 1 1 } } }
}
