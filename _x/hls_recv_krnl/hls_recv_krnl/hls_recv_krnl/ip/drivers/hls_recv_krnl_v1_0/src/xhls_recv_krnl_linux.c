...
typedef struct {
    ...
    XHls_recv_krnl_uio_map maps[ MAX_UIO_MAPS ];
} XHls_recv_krnl_uio_info;

/***************** Variable Definitions **************************************/
static XHls_recv_krnl_uio_info uio_info;
...
static int uio_info_read_name(XHls_recv_krnl_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XHls_recv_krnl_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XHls_recv_krnl_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XHls_recv_krnl_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XHls_recv_krnl_Initialize(XHls_recv_krnl *InstancePtr, const char* InstanceName) {
	XHls_recv_krnl_uio_info *InfoPtr = &uio_info;
